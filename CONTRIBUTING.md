...
and `/src` directories and rebuilds the website accordingly. Therefore, after 
saving each change, you should be able to refresh your browser and see the changes. 
If not, go to Terminal or Command Prompt and see if there were errors during the
regeneration phase.
